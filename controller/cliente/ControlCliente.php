...
class ControlCliente
{
    ...
    function registrarCliente()
    {
        ...
        $comandoSql = $queryUpdate->table("habeas_data")
            ->set(["tDocumento" => $tDocumento, "id" => $documento, "nombre" => $nombres, "apellido" => $apellidos, "sexo" => $sexo, "fecha_nacimiento" => $fechaNacimiento, "email" => $email, "telefono" => $telefono, "direccion" => $direccion, "ciudad" => $ciudad, "region" => $region, "terminos" => $terminos, "medio_envio" => $medioEnvio, "tipo_registro" => $tipoRegistro])
