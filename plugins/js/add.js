                ...
                var o = FormValidation.formValidation(e, {
                    fields: {
                        ...
                        area: {
                            validators: {
                                notEmpty: {
                                    message: "El area del usuario es requerido"
                                }
                            }
                        },
                        user_role: {
                ...
                i.addEventListener("click", (t => {
                    t.preventDefault(), o && o.validate().then((function(t) {
                        console.log("validated!"), "Valid" == t ? (i.setAttribute("data-kt-indicator", "on"), i.disabled = !0, setTimeout((function() {
                            ...
                            text: "Lo siento, parece que hubo un error, por favor intenta de nuevo.",
                            icon: "error",
                            buttonsStyling: !1,
                    ...
                    t.preventDefault(), Swal.fire({
                        text: "Esta seguro que quieres cancelar?",
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
