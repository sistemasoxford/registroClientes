        ...
        ! function() {
            ...
            if (e) {
                ...
                i("#E4E6EF", t.lineWidth, 1),
                    i(KTUtil.getCssVariableValue("--bs-success"), t.lineWidth, .8),
                    i(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, .6),
                    i(KTUtil.getCssVariableValue("--bs-secondary"), t.lineWidth, .1),
                    i(KTUtil.getCssVariableValue("--bs-warning"), t.lineWidth, .1)
            }
        }()
    }
};
                        ...
                        tooltip: {
                            ...
                            x: {
                                formatter: function(e, { series, seriesIndex, dataPointIndex, w }) {
                                    return fechas[dataPointIndex]; // Mostrar la fecha en el tooltip
                                }
                            },
                            y: {
                                formatter: function(e) {
                                    return e + " Incidencias"; // Mostrar la cantidad de incidencias en el tooltip
                                }
                            }
                        },
                ...
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    o = {
                        ...
                        tooltip: {
                            ...
                            x: {
                                formatter: function(e, { series, seriesIndex, dataPointIndex, w }) {
                                    return fechas1[dataPointIndex]; // Mostrar la fecha en el tooltip
                                }
                            },
                            y: {
                                formatter: function(e) {
...
var KTCardWidget14 = function() {
    var e = {
        ...
        t = function(e) {
            ...
            var t = document.getElementById("kt_card_widget_14_chart");
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    r = KTUtil.getCssVariableValue("--bs-gray-800"),
                    o = {
                        ...
                        tooltip: {
                            ...
                            x: {
                                formatter: function(e, { series, seriesIndex, dataPointIndex, w }) {
                                    return fechas3[dataPointIndex]; // Mostrar la fecha en el tooltip
                                }
                            },
                            y: {
                                formatter: function(e) {
...
"undefined" != typeof module && (module.exports = KTCardWidget14), KTUtil.onDOMContentLoaded((function() {
    KTCardWidget14.init()
}));
var KTCardWidget15 = function() {
    var e = {
            self: null,
            rendered: !1
        },
        t = function(e) {
            var t = document.getElementById("kt_card_widget_15_chart");
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    r = KTUtil.getCssVariableValue("--bs-gray-800"),
                    o = {
                        ...
                        tooltip: {
                            ...
                            x: {
                                formatter: function(e, { series, seriesIndex, dataPointIndex, w }) {
                                    return fechas4[dataPointIndex]; // Mostrar la fecha en el tooltip
                                }
                            },
                            y: {
                                formatter: function(e) {
...
"undefined" != typeof module && (module.exports = KTCardWidget15), KTUtil.onDOMContentLoaded((function() {
    KTCardWidget15.init()
}));
var KTCardsWidget17 = {
    init: function() {
