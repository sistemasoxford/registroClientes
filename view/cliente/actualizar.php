                                            ...
                                            <div class="fv-row mb-5 col-md-12">
                                                ...
                                                <div class="row gx-3">
                                                    <div class="fv-row mb-5 col-md-4">
                                                        ...
                                                        <input type="tel" placeholder="Día" id="BithDateDay" name="BirthDateDay" class="form-control bg-transparent" maxlength = "2" value="<?php echo $_SESSION["usuario"]["BirthDateDay"] ?? null; ?>"/>
                                                    </div>
                                                    ...
                                                    <div class="fv-row mb-5 col-md-4">
                                                        ...
                                                        <input type="tel" id="BirthDateYear" name="BirthDateYear" placeholder="Año" class="form-control bg-transparent" maxlength = "4" value="<?php echo $_SESSION["usuario"]["BirthDateYear"] ?? null; ?>"/>
                                                    </div>
                                                </div>
                                            </div>
