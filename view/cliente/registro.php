                                    ...
                                    <div class="w-lg-500px p-10">
                                        ...
                                        <form class="form w-100 row" id="clienteForm">
                                            ...
                                            <div class="fv-row mb-5 col-md-4 pe-0">
                                                ...
                                                <input type="number" name="BirthDateDay" class="form-control bg-transparent" value=""/>
                                            </div>
                                            <div class="fv-row mb-5 col-md-4 pe-0">
                                                <label class="mb-2">Mes</label>
                                                <input type="number" name="BirthDateMonth" class="form-control bg-transparent" value=""/>
                                            </div>
                                            <div class="fv-row mb-5 col-md-4 pe-0">
                                                <label class="mb-2">Año</label>
                                                <input type="number" name="BirthDateYear" class="form-control bg-transparent" value=""/>
                                            </div>

                                            <!-- Email -->
                                            <div class="fv-row mb-5 col-md-12 pe-0">
                                                <label class="mb-2 required">Correo</label>
                                                <input type="email" name="Email" autocomplete="off" class="form-control bg-transparent" value=""/>
                                            </div>
