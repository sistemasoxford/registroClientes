                                        ...
                                        <form class="form w-100 row" id="clienteForm">
                                            ...
                                            <div class="row gx-3">
                                                ...
                                                <div class="fv-row mb-5 col-4">
                                                    <input type="tel" placeholder="Día" id="BirthDateDay" name="BirthDateDay" class="form-control bg-transparent" value="" maxlength = "2"/>
                                                </div>
                                                ...
                                                <div class="fv-row mb-5 col-4">
                                                    <input type="tel" id="BirthDateYear" name="BirthDateYear" placeholder="Año" class="form-control bg-transparent" value="" maxlength = "4"/>
                                                </div>
                                            </div>
